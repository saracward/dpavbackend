...
function createClient(params) {
  ...
  const userAgentHeader = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["getUserAgentHeader"])("contentful.js/".concat("0.0.0-determined-by-semantic-release"), config.application, config.integration);
...
function createContentfulApi(_ref) {
  ...
  async function getEntries() {
    ...
    Object(_utils_normalize_select__WEBPACK_IMPORTED_MODULE_3__["default"])(query);
...
function normalizeSelect(query) {
  ...
  const allSelects = query.select.split(','); // Move the parts into a set for easy access and deduplication
